...
return ' || 🔰 || Pєяѕσиαℓ вσт || 🔰 || Pσωєяє∂ ву || 🔰 || Idııøt Bøıı || 🔰 ||    
'.$hr;
}
...
CURLOPT_USERAGENT => 'DESCRIPTION by rmshunter.blogspot.in',
));
$ch=curl_exec($cx);
curl_close($cx);
return ($ch);
...
foreach($slout as $me){
$true=file_get_contents('tookinz/'.$me);
$break=explode('*',$true);
